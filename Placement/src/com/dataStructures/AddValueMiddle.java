...
public class AddValueMiddle {
	...
	public static void main(String[] args) {
		...
		AddValueMiddle a=new AddValueMiddle();
		...
		//adding value in the middle of linked list
		     System.out.println("enter the middle value");
		     a.middleValue=sc.nextInt();
           a.addValueMiddle(a.middleValue,a.head);
	 ...
	 void addValueMiddle(int value,Node head)
	 {
		 Node temp=null;
		 Node p;
		 Node q;
